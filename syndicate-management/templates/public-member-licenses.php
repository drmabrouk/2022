    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
        ...
        <div class="sm-card" style="background: #fff; padding: 25px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
            ...
            <?php if (!empty($member->license_number)): ?>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; background: #f8fafc; padding: 15px; border-radius: 8px; border: 1px solid #f1f5f9;">
        ...
        <div class="sm-card" style="background: #fff; padding: 25px; border-radius: 12px; border: 1px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
            ...
            <?php if (!empty($member->facility_number)): ?>
                <div style="display: grid; gap: 10px; background: #f0f9ff; padding: 15px; border-radius: 8px; border: 1px solid #e0f2fe;">
            ...
            <div style="margin-top: 20px;">
                ...
                <?php else: ?>
                    <div style="background: #fffbeb; color: #92400e; padding: 12px; border-radius: 8px; font-size: 11px; border: 1px solid #fde68a; display: flex; gap: 8px; align-items: center;">
