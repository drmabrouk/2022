...
<head>
    ...
    <style>
        ...
        body { font-family: 'Rubik', sans-serif; margin: 0; padding: 15px; background: #fff; }
        .header { text-align: center; margin-bottom: 10px; border-bottom: 2px solid #111F35; padding-bottom: 20px; }
