                    ...
                    if ($is_admin || $is_sys_admin) {
                            ...
                            <div style="background:#fff; border:1px solid #e2e8f0; border-radius:12px; padding: 25px;">
                                ...
                                <section style="background:#fffbeb; padding:20px; border-radius:10px; border:1px solid #fef3c7;">
                                    ...
                                    <div style="font-size:12px; color:#92400e; line-height:1.8;">
                                        <p>• <strong>الأمن والحماية:</strong> النظام مطور بمعايير عالية للحماية من هجمات IDOR؛ حيث يتم التحقق من ملكية البيانات في كل عملية AJAX.</p>
                                        ...
                                        <p>• <strong>البيانات الضخمة:</strong> الجداول مصممة لاستيعاب مئات الآلاف من السجلات مع محرك بحث يعمل بنظام Full-text search لضمان السرعة.</p>
                                        <p>• <strong>التطوير المستقبلي:</strong> كافة العمليات الهامة مسجلة في "سجل النشاطات" (Logs) بما يسمح بتتبع الأخطاء أو استعادة البيانات المحذوفة يدوياً.</p>
                                    </div>
                                </section>
                            </div>
                        </div>
                        ...
                        <div id="verification-settings" class="sm-internal-tab" style="display: <?php echo ($sub == 'verification') ? 'block' : 'none'; ?>;">
                            <div style="background:#fff; border:1px solid #e2e8f0; border-radius:12px; padding: 20px;">
                                <h4 style="margin:0 0 20px 0;">إعدادات بوابة التحقق المهني</h4>
                                <form method="post">
                                    <?php wp_nonce_field('sm_admin_action', 'sm_admin_nonce'); ?>
                                    <div class="sm-form-group">
                                        <label class="sm-label">عنوان البوابة:</label>
                                    ...
                                    <div class="sm-form-group">
                                        <label class="sm-label">وصف البوابة:</label>
                                    ...
                                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                                        <div class="sm-form-group">
                                            <label class="sm-label">عرض بيانات العضوية:</label>
                                            <select name="sm_verify_show_membership" class="sm-select">
                                                <option value="1" <?php selected(get_option('sm_verify_show_membership', 1), 1); ?>>نعم</option>
                                                <option value="0" <?php selected(get_option('sm_verify_show_membership', 1), 0); ?>>لا</option>
                                            </select>
                                        </div>
                                        <div class="sm-form-group">
                                            <label class="sm-label">عرض بيانات تصريح المزاولة:</label>
                                            <select name="sm_verify_show_practice" class="sm-select">
                                                <option value="1" <?php selected(get_option('sm_verify_show_practice', 1), 1); ?>>نعم</option>
                                                <option value="0" <?php selected(get_option('sm_verify_show_practice', 1), 0); ?>>لا</option>
                                            </select>
                                        </div>
                                    </div>
                                    <button type="submit" name="sm_save_verify_settings" class="sm-btn" style="width:auto; height:45px; padding:0 30px;">حفظ إعدادات التحقق</button>
                                </form>
                            </div>
                        </div>
