    ...
    window.smOpenFinanceModal = function(memberId) {
        ...
        .then(res => {
            if (res.success) {
                ...
                body.innerHTML = '<div style="color:red; text-align:center; padding: 10px;">' + res.data + '</div>';
            }
        });
    };
...
<div class="sm-admin-dashboard" dir="rtl" style="font-family: 'Rubik', sans-serif; background: <?php echo $appearance['bg_color']; ?>; border: 1px solid var(--sm-border-color); border-radius: 12px; overflow: hidden; color: <?php echo $appearance['font_color']; ?>; font-size: <?php echo $appearance['font_size']; ?>; font-weight: <?php echo $appearance['font_weight']; ?>; line-height: <?php echo $appearance['line_spacing']; ?>;">
    ...
    <div class="sm-admin-layout" style="display: flex; min-height: 800px;">
        ...
        <!-- CONTENT AREA -->
        <div class="sm-main-panel" style="flex: 1; min-width: 0; padding: 15px; background: #fff;">
            ...
            switch ($active_tab) {
                ...
                case 'advanced-settings':
                    if ($is_admin || $is_sys_admin) {
                        $sub = $_GET['sub'] ?? 'staff';
                        ?>
                        <div class="sm-tabs-wrapper" style="display: flex; gap: 10px; margin-bottom: 10px; border-bottom: 2px solid #eee; overflow-x: auto; white-space: nowrap; padding-bottom: 10px;">
                        ...
                        <div id="system-alerts-settings" class="sm-internal-tab" style="display: <?php echo ($sub == 'alerts') ? 'block' : 'none'; ?>;">
                            <div style="background:#fff; border:1px solid #e2e8f0; border-radius:12px; padding: 10px; margin-bottom: 10px;">
                        ...
                        <div id="backup-settings" class="sm-internal-tab" style="display: <?php echo ($sub == 'backup') ? 'block' : 'none'; ?>;">
                            <div style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px; padding: 15px;">
                                ...
                                <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap:20px;">
                                    ...
                                    <div style="background:#fff5f5; padding: 10px; border-radius:8px; border:1px solid #feb2b2; grid-column: 1 / -1;">
                                ...
                                <div class="sm-table-container" style="margin:0; overflow-x:auto;">
                                    <table class="sm-table" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            if (empty($all_logs)): ?>
                                                <tr><td colspan="5" style="text-align:center; padding: 10px; color:#94a3b8;">لا توجد سجلات تطابق البحث</td></tr>
                                            <?php endif;
                    ...
                    if ($is_admin || $is_sys_admin || $is_syndicate_admin) {
                        ...
                        <div id="academic-settings" class="sm-internal-tab" style="display: <?php echo ($sub == 'academic') ? 'block' : 'none'; ?>;">
                            <form method="post">
                                ...
                                <div style="margin-top: 10px; padding: 15px; background: #fffaf0; border: 1px solid #feebc8; border-radius: 8px; font-size: 13px; color: #744210;">
                                    <strong>تنبيه:</strong> سيتم استخدام هذه المسميات في كافة نماذج النظام (تسجيل، تعديل، طباعة تقارير).
                                </div>
                                <button type="submit" name="sm_save_academic_options" class="sm-btn" style="width:auto; margin-top: 10px; padding: 0 50px; height: 50px; font-weight: 800;">حفظ مسميات الحقول</button>
                            </form>
                        </div>
...
<div id="sm-alert-modal" class="sm-modal-overlay">
    <div class="sm-modal-content" style="max-width: 600px;">
        ...
        <form id="sm-alert-form" style="padding: 15px;">
            ...
            <div style="background: #f8fafc; padding: 15px; border-radius: 8px; border: 1px solid #edf2f7; margin-bottom: 10px;">
                <label class="sm-label" style="color: var(--sm-primary-color); border-bottom: 1px solid #eee; padding-bottom: 5px; margin-bottom: 10px;">استهداف العرض:</label>
