...
class SM_System_Manager {
    ...
    public static function ajax_delete_branch() {
        try {
            SM_Access::check_capability('sm_full_access');
            SM_Access::verify_nonce('sm_admin_action', isset($_POST['nonce']) ? 'nonce' : 'sm_admin_nonce');
    ...
    public static function ajax_save_alert() {
        try {
            SM_Access::check_any_capability(['sm_manage_system', 'manage_options']);
            SM_Access::verify_nonce('sm_admin_action', isset($_POST['nonce']) ? 'nonce' : 'sm_admin_nonce');
    ...
    public static function ajax_delete_log() {
        try {
            SM_Access::check_capability('manage_options');
            SM_Access::verify_nonce('sm_admin_action', isset($_POST['nonce']) ? 'nonce' : 'sm_admin_nonce');
    ...
    public static function ajax_generate_pub_doc() {
        SM_Access::check_capability('sm_manage_system');
        SM_Access::verify_nonce('sm_pub_action', isset($_POST['nonce']) ? 'nonce' : '_wpnonce');
