...
class SM_Finance_Manager {
    ...
    public static function ajax_record_payment() {
        try {
            SM_Access::check_any_capability(['sm_manage_finance', 'manage_options']);
            SM_Access::verify_nonce('sm_finance_action');
            ...
            if (SM_Finance::record_payment($_POST)) {
                ...
                if ($member && $member->governorate) {
                    delete_transient('sm_stats_' . $member->governorate);
                }
    ...
    public static function ajax_delete_transaction() {
        try {
            SM_Access::check_any_capability(['sm_full_access', 'manage_options']);
    ...
    public static function ajax_export_finance_report() {
        SM_Access::check_capability('sm_manage_finance');
    ...
    public static function ajax_print_invoice() {
        ...
        SM_Access::validate_member_access($pmt->member_id);
